<?php
/**
 * 403 Forbidden – Access denied template
 */
if (!defined('ABSPATH')) {
    exit;
}
...
<main id="content" class="min-h-[60vh]">
    <section class="relative px-4 sm:px-6 lg:px-8 pt-32 pb-20 md:pt-40 md:pb-28 bg-gradient-to-br from-primary-dark via-primary to-primary-light overflow-hidden">
        ...
        <div class="relative z-10 max-w-7xl mx-auto text-center">
            <p class="text-8xl sm:text-9xl font-bold text-white/20 select-none leading-none">403</p>
            <h1 class="text-2xl sm:text-3xl md:text-4xl font-bold text-white mt-4 mb-4">Access Denied</h1>
