    ...
    acf_add_local_field_group(array(
        ...
        'fields'                => array(
            ...
            array('key' => 'field_glance_hl_cards', 'label' => __('Highlight Cards', 'mlzs'), 'name' => 'glance_hl_cards', 'type' => 'repeater', 'layout' => 'block', 'min' => 4, 'max' => 4, 'button_label' => __('Add Card', 'mlzs'), 'sub_fields' => array(
                ...
                array('key' => 'field_glance_hl_card_style', 'label' => __('Style (Tailwind)', 'mlzs'), 'name' => 'style', 'type' => 'text', 'default_value' => 'primary', 'instructions' => __('primary, accent, primary-light, accent-dark', 'mlzs')),
            )),
