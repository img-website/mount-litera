        ...
        <div class="max-w-7xl mx-auto">
            <div class="masonry-grid" id="gallery-grid">
                ...
                <a href="<?php echo esc_url($full_url); ?>"
                   ...
                   class="masonry-item group relative overflow-hidden rounded-[0.5rem] sm:rounded-[0.75rem] bg-gray-100 hover:scale-105 transition-transform duration-300 cursor-pointer block">
