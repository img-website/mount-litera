    ...
    acf_add_local_field_group(array(
        ...
        'fields'                => array(
            ...
            array('key' => 'field_eap_exam_blocks', 'label' => __('Exam Sections (Grades III–V, VI–VIII, IX–XII)', 'mlzs'), 'name' => 'eap_exam_blocks', 'type' => 'repeater', 'layout' => 'block', 'button_label' => __('Add Exam Section', 'mlzs'), 'sub_fields' => array(
                ...
                array('key' => 'field_eap_verbal_note', 'label' => __('Verbal Note (single, fallback)', 'mlzs'), 'name' => 'verbal_note', 'type' => 'textarea', 'rows' => 2, 'instructions' => __('Used only if "Verbal Notes" below is empty.', 'mlzs')),
                array('key' => 'field_eap_verbal_notes', 'label' => __('Verbal Notes (multiple)', 'mlzs'), 'name' => 'verbal_notes', 'type' => 'repeater', 'layout' => 'block', 'button_label' => __('Add Note', 'mlzs'), 'sub_fields' => array(
                    array('key' => 'field_eap_vnote_text', 'label' => __('Note Text', 'mlzs'), 'name' => 'note_text', 'type' => 'textarea', 'rows' => 2),
                    array('key' => 'field_eap_vnote_icon', 'label' => __('Icon', 'mlzs'), 'name' => 'note_icon', 'type' => 'text', 'default_value' => 'info'),
                    array('key' => 'field_eap_vnote_style', 'label' => __('Box style', 'mlzs'), 'name' => 'note_style', 'type' => 'select', 'choices' => array('blue' => 'Blue', 'amber' => 'Amber'), 'default_value' => 'blue'),
                )),
                array('key' => 'field_eap_verbal_note_icon', 'label' => __('Verbal Note Icon (fallback)', 'mlzs'), 'name' => 'verbal_note_icon', 'type' => 'text', 'default_value' => 'info'),
                array('key' => 'field_eap_verbal_note_style', 'label' => __('Verbal note box style (fallback)', 'mlzs'), 'name' => 'verbal_note_style', 'type' => 'select', 'choices' => array('blue' => 'Blue', 'amber' => 'Amber'), 'default_value' => 'blue'),
                array('key' => 'field_eap_verbal_header_labels', 'label' => __('Verbal Table Column Headers (optional, after Date & Day)', 'mlzs'), 'name' => 'verbal_header_labels', 'type' => 'textarea', 'rows' => 3, 'instructions' => __('Leave empty for Date | Day | Subject. Or add one header per line (e.g. Grade XI, Grade XII) for extra columns — up to 6.', 'mlzs')),
                array('key' => 'field_eap_verbal_rows', 'label' => __('Verbal Table Rows', 'mlzs'), 'name' => 'verbal_rows', 'type' => 'repeater', 'layout' => 'table', 'button_label' => __('Add Row', 'mlzs'), 'sub_fields' => array(
                    ...
                    array('key' => 'field_eap_vr_subject', 'label' => __('Subject (when no column headers above)', 'mlzs'), 'name' => 'subject', 'type' => 'textarea', 'rows' => 1),
                    array('key' => 'field_eap_vr_col1', 'label' => __('Col 1', 'mlzs'), 'name' => 'col1', 'type' => 'textarea', 'rows' => 1),
                    array('key' => 'field_eap_vr_col2', 'label' => __('Col 2', 'mlzs'), 'name' => 'col2', 'type' => 'textarea', 'rows' => 1),
                    array('key' => 'field_eap_vr_col3', 'label' => __('Col 3', 'mlzs'), 'name' => 'col3', 'type' => 'textarea', 'rows' => 1),
                    array('key' => 'field_eap_vr_col4', 'label' => __('Col 4', 'mlzs'), 'name' => 'col4', 'type' => 'textarea', 'rows' => 1),
                    array('key' => 'field_eap_vr_col5', 'label' => __('Col 5', 'mlzs'), 'name' => 'col5', 'type' => 'textarea', 'rows' => 1),
                    array('key' => 'field_eap_vr_col6', 'label' => __('Col 6', 'mlzs'), 'name' => 'col6', 'type' => 'textarea', 'rows' => 1),
                )),
                ...
                array('key' => 'field_eap_written_note', 'label' => __('Written Note (single, fallback)', 'mlzs'), 'name' => 'written_note', 'type' => 'textarea', 'rows' => 2, 'instructions' => __('Used only if "Written Notes" below is empty.', 'mlzs')),
                array('key' => 'field_eap_written_notes', 'label' => __('Written Notes (multiple)', 'mlzs'), 'name' => 'written_notes', 'type' => 'repeater', 'layout' => 'block', 'button_label' => __('Add Note', 'mlzs'), 'sub_fields' => array(
                    array('key' => 'field_eap_wnote_text', 'label' => __('Note Text', 'mlzs'), 'name' => 'note_text', 'type' => 'textarea', 'rows' => 2),
                    array('key' => 'field_eap_wnote_icon', 'label' => __('Icon', 'mlzs'), 'name' => 'note_icon', 'type' => 'text', 'default_value' => 'alert-circle'),
                    array('key' => 'field_eap_wnote_style', 'label' => __('Box style', 'mlzs'), 'name' => 'note_style', 'type' => 'select', 'choices' => array('blue' => 'Blue', 'amber' => 'Amber'), 'default_value' => 'amber'),
                )),
                array('key' => 'field_eap_written_note_icon', 'label' => __('Written Note Icon (fallback)', 'mlzs'), 'name' => 'written_note_icon', 'type' => 'text', 'default_value' => 'alert-circle'),
                array('key' => 'field_eap_written_note_style', 'label' => __('Written note box style (fallback)', 'mlzs'), 'name' => 'written_note_style', 'type' => 'select', 'choices' => array('blue' => 'Blue', 'amber' => 'Amber'), 'default_value' => 'amber'),
                array('key' => 'field_eap_written_header_labels', 'label' => __('Written Table Column Headers (one per line, after Date)', 'mlzs'), 'name' => 'written_header_labels', 'type' => 'textarea', 'rows' => 5, 'instructions' => __('e.g. Grade III, Grade IV, Grade V — or Grade IX, Grade X, Grade XI, Grade XII (up to 6 columns).', 'mlzs')),
                array('key' => 'field_eap_written_rows', 'label' => __('Written Table Rows', 'mlzs'), 'name' => 'written_rows', 'type' => 'repeater', 'layout' => 'table', 'button_label' => __('Add Row', 'mlzs'), 'sub_fields' => array(
                    ...
                    array('key' => 'field_eap_wr_col6', 'label' => __('Col 6', 'mlzs'), 'name' => 'col6', 'type' => 'textarea', 'rows' => 1),
                )),
            )),
