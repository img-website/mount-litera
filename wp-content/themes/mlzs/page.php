<?php
/**
 * Default page template for pages without a custom template (e.g. Terms & Conditions).
 */
if (!defined('ABSPATH')) {
    exit;
}
...
$hero_heading  = $opt ? get_field('default_page_hero_heading', $page_id) : null;
$hero_subtext  = $opt ? get_field('default_page_hero_subtext', $page_id) : null;
$hero_bg       = $opt ? get_field('default_page_hero_bg_image', $page_id) : null;
